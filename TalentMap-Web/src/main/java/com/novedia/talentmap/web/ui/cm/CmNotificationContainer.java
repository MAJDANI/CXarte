...
public class CmNotificationContainer extends BeanItemContainer<UserNotification> {
	...
	public CmNotificationContainer fillContainer(int collabId){
		...
		try {
			List<UserNotification> CmListNotification = this.notificationService.getAllNotification(collabId);
			removeAllItems();
