...
public class ProfileNavigation extends VerticalLayout implements IObservable,ItemClickListener {
	...
	public void itemClick(ItemClickEvent event) {
		if(event.getSource() == tree){
			...
			if(itemId != null){
				if(itemId.equals(ConstantsForMenuEnglish.VISUALIZE_ADMINISTRATIVE_DATA)){
				...
				else if(itemId.equals(ConstantsForMenuEnglish.VISUALIZE_SKILLS_NAME)){
