...
public class AdminNavigation extends VerticalLayout implements IObservable,
		ItemClickListener {
			...
			if (itemId != null) {
				if (itemId.equals(ConstantsForMenuEnglish.ADMIN_ADD_SKILL_NAME)) {
					...
					this.updateObservateur();
						...
						.equals(ConstantsForMenuEnglish.ADMIN_VIEW_SKILL_NAME)) {
					this.cl = ManageSkillContent.class;
					this.updateObservateur();
				} else if (itemId
						.equals(ConstantsForMenuEnglish.ADMIN_DELETE_COLLAB_NAME)) {
