	...
	private void buildObersvators() {
		...
		this.addSkillPanel.addObservateur(new IProfileView() {
			...
			public void updateListSkill(ListSkill listSkill) {
				...
				ProfileCollaboratorContent.this.listSkill = listSkill;
				ProfileCollaboratorContent.this.listSkill.setVisible(true);
				ProfileCollaboratorContent.this.edit.setVisible(true);
				ProfileCollaboratorContent.this.listSkill.setMargin(true);

				ProfileCollaboratorContent.this.addSkillPanel.setVisible(false);
				ProfileCollaboratorContent.this.edit.setEnabled(true);

				ProfileCollaboratorContent.this.listSkillPanel.removeAllComponents();
