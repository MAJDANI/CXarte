...
public class administration extends CustomComponent {
	...
	private AbsoluteLayout buildAbsoluteLayout_3() {
		...
		absoluteLayout_3.setHeight("363px");
		...
		absoluteLayout_3.addComponent(textField_2, "top:23.0px;left:108.0px;");
		...
		absoluteLayout_3.addComponent(textField_3, "top:63.0px;left:108.0px;");
		...
		label_4.setValue("Concept : ");
		absoluteLayout_3.addComponent(label_4, "top:67.0px;left:23.0px;");
		...
		label_5.setValue("Outil : ");
		absoluteLayout_3.addComponent(label_5, "top:105.0px;left:23.0px;");
		...
		absoluteLayout_3.addComponent(textField_4, "top:103.0px;left:108.0px;");
		
		// nativeButton_1
		nativeButton_1 = new NativeButton();
		nativeButton_1.setCaption("Enregistrer");
		...
		absoluteLayout_3.addComponent(tree_1, "top:23.0px;left:349.0px;");
