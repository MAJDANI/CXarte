...
public class MonitoringCollabContentLayout extends HorizontalLayout {
	...
	this.monitoringCollabNavigation.addObservateur(new ICollabLayout() {
		...
		if (cl == MonitoringCollabContent.class) {
		    ...
		    MonitoringCollabContentLayout.this.monitoringCollabContent
			    .setVisible(true);
		    MonitoringCollabContentLayout.this.historyMissionColab
			    .setVisible(false);
		    MonitoringCollabContentLayout.this.objectiveEa
			    .setVisible(false);
		    MonitoringCollabContentLayout.this.hSplitPanel
			    .setSecondComponent(MonitoringCollabContentLayout.this.monitoringCollabContent);
		}
		...
		if (cl == HistoryMissionColab.class) {
		    ...
		    MonitoringCollabContentLayout.this.objectiveEa
			    .setVisible(false);
		    MonitoringCollabContentLayout.this.hSplitPanel
			    .setSecondComponent(MonitoringCollabContentLayout.this.historyMissionColab);
		...
		if (cl == ObjectiveEa.class) {
		    ...
		    MonitoringCollabContentLayout.this.historyMissionColab
			    .setVisible(false);
		    MonitoringCollabContentLayout.this.hSplitPanel
			    .setSecondComponent(MonitoringCollabContentLayout.this.objectiveEa);
		}
	    }
	}, ICollabLayout.class);
