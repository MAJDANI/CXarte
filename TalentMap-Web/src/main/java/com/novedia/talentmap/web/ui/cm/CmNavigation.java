...
public class CmNavigation extends VerticalLayout implements IObservable,
	ItemClickListener {
	...
	if (event.getSource() == tree) {
		...
		if (itemId.equals(ConstantsForMenuEnglish.CM_SEARCH_BY_CLIENT)) {
			...
			.equals(ConstantsForMenuEnglish.CM_SEARCH_BY_SKILL)) {
		    this.searchTargetPanel = SearchTargetPanel.BY_SKILLS;
		    updateObservateur();
		} else if (itemId
			.equals(ConstantsForMenuEnglish.CM_SEARCH_BY_NAME)) {
