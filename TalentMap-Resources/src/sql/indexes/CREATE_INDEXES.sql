...
CREATE INDEX COLLABORATORIDX1 ON COLLABORATOR (COLLAB_ID) TABLESPACE tmp00idx;
...
CREATE INDEX CONCEPTIDX2 ON CONCEPT (CATEG_ID) TABLESPACE tmp00idx;
...
CREATE INDEX SCOREIDX1 ON SCORE (COLLAB_ID) TABLESPACE tmp00idx;

DROP INDEX SCOREIDX2;
CREATE INDEX SCOREIDX2 ON SCORE (TOOL_ID) TABLESPACE tmp00idx;
...
CREATE INDEX MISSIONIDX2 ON MISSION (COLLAB_ID) TABLESPACE tmp00idx;
