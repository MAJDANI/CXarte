...
-- CREATION DES INDEX --
------------------------
DROP INDEX COLLEAGUEIDX;
CREATE INDEX COLLEAGUEIDX1 ON COLLEAGUE (COLLEAGUE_ID) TABLESPACE tmptestidx;
...
CREATE INDEX SCOREIDX1 ON SCORE (COLLEAGUE_ID) TABLESPACE tmptestidx;
...
CREATE INDEX MISSIONIDX2 ON MISSION (COLLEAGUE_ID) TABLESPACE tmptestidx;
