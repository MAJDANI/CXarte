...
public class ToolDaoTest {
	...
	public void testGetAll() throws Exception {
		...
		// Then
		ReflectionAssert.assertPropertyLenientEquals("id", Arrays.asList(1,2,3), toolsList);
		ReflectionAssert.assertPropertyLenientEquals("name", Arrays.asList("MYBATIS","HIBERNATE","SPRING JDBC"), toolsList);
		ReflectionAssert.assertPropertyLenientEquals("concept", Arrays.asList(expectedCpt,expectedCpt,expectedCpt), toolsList);
	}
	...
	public void testSave () throws Exception{
		...
		Concept concept = Concept.builder().id(1).name("ORM").category(category).build();
	...
	public void testDelete() throws Exception {
		...
		Category category = Category.builder().id(1).name("JAVA").build();
		Concept concept = Concept.builder().id(1).name("ORM").category(category).build();
		Tool tool = Tool.builder().id(1).name("MYBATIS").concept(concept).build();
	...
	public void testAdd() throws Exception {
		...
		Category category = Category.builder().id(1).name("JAVA").build();
		Concept concept = Concept.builder().id(1).name("ORM").category(category).build();
		Tool tool = Tool.builder().name("ActiveObjects").concept(concept).build();
