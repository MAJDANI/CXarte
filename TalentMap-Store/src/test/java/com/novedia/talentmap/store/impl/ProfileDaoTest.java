...
public class ProfileDaoTest {
	...
	ReflectionAssert.assertPropertyReflectionEquals("type",
	...
	ReflectionAssert.assertPropertyLenientEquals("id",
		Arrays.asList(1, 2, 3, 4, 5), profiles);
	ReflectionAssert.assertPropertyLenientEquals("type", Arrays.asList(
		"Business Analyst", "Developer", "Software Architect",
		"Tester", "Project Manager"), profiles);
    }
