...
public class NotificationDao extends SqlMapClientDaoSupport implements
	...
	@Override
	public List<UserNotification> getAllByManagerId(Integer collabId)
			throws DataAccessException {
		return (List<UserNotification>) this.getSqlMapClientTemplate()
				.queryForList(
						DBRequestsConstants.GET_ALL_NOTIFICATION_BY_MANAGER_ID,
						collabId);
	}
	...
	public List<Frequency> getAllFrequencyChoices() throws DataAccessException {
		return (List<Frequency>) this.getSqlMapClientTemplate().queryForList(
				DBRequestsConstants.GET_ALL_FREQUENCY_CHOICES);
	}

	@Override
	public Frequency getCmFrequencyOption(Integer managerId)
			throws DataAccessException {
		return (Frequency) this.getSqlMapClientTemplate().queryForObject(
				DBRequestsConstants.GET_CM_FREQUENCY_OPTION, managerId);
	}
	...
	public Integer saveFrequencyOption(int frequencyId, int managerId)
		...
		return (Integer) this.getSqlMapClientTemplate().update(
				DBRequestsConstants.SAVE_CM_FREQUENCY_OPTION, parameters);
	}
	...
	public Integer addFrequencyOption(int frequencyId, int managerId)
		...
		parameters.put("managerId", managerId);
		return (Integer) this.getSqlMapClientTemplate().insert(
				DBRequestsConstants.ADD_CM_FREQUENCY_OPTION, parameters);
	}
