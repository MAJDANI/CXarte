...
.insert(DBRequestsConstants.ADD_SKILL, skill);
}

/**
 * Delete a skill.
 * @param element type skill
 * @return int
 * @throws DataAccessException
 */
@Override
...
.queryForList("skill.getAllCollaboratorSkill", collaboratorId);
}

/**
 * @param collaborator_id a collaborator_id.
 * @param tool_id
...
return (Skill) this.getSqlMapClientTemplate()
.queryForObject("skill.getSkill", mapId);
}
...
public List<Integer> getAllCollaboratorsIdByToolId(int toolId) throws DataAccessException {
	...
	return this.getSqlMapClientTemplate().queryForList(DBRequestsConstants
	.GET_ALL_COLLABORATORS_BY_TOOL, toolId);
}
 ...
 * @param toolId : a toolId
 * @param listCollaboratorId of collaborator's Id
...
public List<Integer> getAllCollaboratorIdByToolIdAndCollabList(int toolId, List<Integer> listCollaboratorId) throws DataAccessException {
	...
	DBRequestsConstants.GET_ALL_COLLABORATORID_BY_TOOL, skillParameter);
 ...
 */
@SuppressWarnings("unchecked")
public List<Skill> getAllSkillsByCollaborator(final Collaborator collab) {
return this.getSqlMapClientTemplate().queryForList(DBRequestsConstants
.GET_ALL_SKILLS_BY_COLLABORATOR, collab);
}
}