...
public class EAEObjectiveForm extends FormLayout implements BlurListener,
	...
	private void buildEAEObjectiveForm() {
		...
		System.out.println("managerScoreDisplayMode = " + managerScoreDisplayMode);
		...
		System.out.println("motivesOrRestraintsDisplayMode = " + motivesOrRestraintsDisplayMode);
		...
		System.out.println("commentsDisplayMode = " + commentsDisplayMode);
