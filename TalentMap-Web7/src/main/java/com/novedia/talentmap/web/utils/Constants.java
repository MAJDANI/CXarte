...
public class Constants {
	...
	public static final String FORMATION_LABEL = "My TRAINING";
	...
	public static final String CONFIRM_PASSWORD_LABEL = "Retype new Password";
	
	public static final String ERROR_OLD_PASSWORD = "Error : You misspelled your old password !!";
